          ...
          <div className="flex items-start gap-2 md:gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs md:text-sm text-blue-800 leading-relaxed">
                Ev qiymətləri qonaq sayından və gün sayından asılı olaraq dəyişir. Sayta yerləşdirilən qiymətlər standart olaraq nəzərdə tutulub. Qiyməti dəqiq öyrənmək və ətraflı məlumat almaq üçün rezerv düyməsinə klik edib bizə mesaj göndərərək ətraflı məlumat əldə edə bilərsiniz.
              </p>
            </div>
          </div>
        </div>
