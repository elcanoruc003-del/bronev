      ...
      <div className="bg-white shadow-sm sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-3 md:px-4 py-2.5 md:py-4 flex items-center justify-between">
          ...
          <button
            ...
            className="flex items-center justify-center w-4 h-4 md:w-7 md:h-7 rounded-full bg-[#FAF8F5] hover:bg-[#E5DDD5] transition-colors"
          >
            <FaHeart className={`text-[10px] md:text-base ${isFavorite ? 'text-red-500' : 'text-[#6B5D4F]'}`} />
          </button>
        </div>
      </div>
