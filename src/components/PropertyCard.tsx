  ...
  return (
    <div className="card-premium group overflow-hidden">
      ...
      <div className="relative h-64 md:h-72 overflow-hidden bg-neutral-100">
        ...
        {/* Favorite Button */}
        <button className="absolute top-3 md:top-4 right-3 md:right-4 w-3 h-3 md:w-12 md:h-12 bg-white/95 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-white hover:scale-110 transition-all duration-300 shadow-lg">
