    ...
    <>
          ...
          <div className="flex items-center justify-between">
            ...
            <Link href="/" className="flex items-center space-x-3 group">
              <div className="relative">
                <div className="absolute inset-0 bg-brand-gold/20 blur-xl rounded-full group-hover:bg-brand-gold/30 transition-all" />
              ...
              <div>
                <h1 className="text-2xl font-display font-bold text-brand-navy">BronEv</h1>
            ...
            <nav className="hidden lg:flex items-center space-x-8">
              <Link href="/" className="text-neutral-700 hover:text-brand-navy font-medium transition-colors relative group">
                Ana səhifə
                <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-brand-gold group-hover:w-full transition-all duration-300" />
              </Link>
              <Link href="/evler" className="text-neutral-700 hover:text-brand-navy font-medium transition-colors relative group">
                Evlər
                <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-brand-gold group-hover:w-full transition-all duration-300" />
              </Link>
            ...
            <button
              ...
              className="lg:hidden p-2 text-brand-navy hover:text-brand-gold transition-colors"
      ...
      {mobileMenuOpen && (
        <div className="fixed inset-0 z-40 lg:hidden">
          ...
          <nav className="absolute top-0 right-0 h-full w-64 bg-white shadow-xl p-6 pt-20">
            <div className="space-y-4">
              <Link href="/" onClick={() => setMobileMenuOpen(false)} className="block py-2 font-medium text-neutral-700 hover:text-brand-navy">
                Ana səhifə
              </Link>
